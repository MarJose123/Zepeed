...
import type { DashboardChartRange } from "@/types/dashboard";
...
const emit = defineEmits<{
    change: [range: DashboardChartRange, from?: string, to?: string];
}>();
...
const PRESETS: {
    label: string;
    value: Exclude<DashboardChartRange, "custom">;
}[] = [
    { label: "1D", value: "1d" },
    { label: "7D", value: "7d" },
    { label: "30D", value: "30d" },
...
function selectPreset(value: Exclude<DashboardChartRange, "custom">): void {
    emit("change", value);
}
    ...
    <div class="flex items-center gap-2">
        ...
        <Popover v-model:open="open">
            ...
            <PopoverContent class="w-68 p-4" align="end">
                <p class="mb-3 text-sm font-medium">Custom date range</p>
