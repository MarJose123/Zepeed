...
import type { PingResultStatus } from "@/types/ping";

const props = defineProps<{ status: PingResultStatus }>();
...
const config = computed(
    () =>
        ({
            ...
            failed: {
                label: "Failed",
                class: "border-red-300 bg-red-50 text-red-700 dark:border-red-800 dark:bg-red-950 dark:text-red-300",
            },
        })[props.status],
);
</script>
