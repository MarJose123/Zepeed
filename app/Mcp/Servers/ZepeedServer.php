...
class ZepeedServer extends Server
{
    protected array $tools = [
        ...
        DeleteWebhook::class,
        TestWebhook::class,
        ListAlertRules::class,
        CreateAlertRule::class,
        UpdateAlertRule::class,
        DeleteAlertRule::class,
        ToggleAlertRule::class,
