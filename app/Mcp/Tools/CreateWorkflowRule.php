...
#[Description('Create a speedtest workflow rule with its conditions and actions. Each rule matches an event (e.g. run fails) against conditions and triggers actions (email and/or webhook) when they all evaluate to true. Requires the workflow-rules:create token ability.')]
