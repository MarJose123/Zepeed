...
#[Description('Update a speedtest workflow rule by id. Conditions and actions are replaced wholesale when their keys are present. Requires the workflow-rules:update token ability.')]
